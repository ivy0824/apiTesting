...
public class DataPrepare {
    ...
    public static String PlannedTicketCode1 ="PT82911";//计划工单编号
    public static String PlannedTicketCode2 ="PT829122";
    ...
    //根据工艺路线+物料清单创建的任务id
    public static int PEId1;
    public static int PEId2;
    public static int PEId3;
